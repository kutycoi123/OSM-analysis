...
def main(input1, input2, output):
    ...
    plt.savefig('../images/Gas_Staion_with_CloseBy_Amenities')
    ...
    #     functions.mean('score').alias('score'),
...
if __name__ == '__main__':
    input1 = '../fuel-Vancouver.json.gz'
    input2 = '../amenities-vancouver.json.gz'
    output = '../fuel_stations_information'
